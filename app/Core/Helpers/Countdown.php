...
use App\Core\Helpers\Countdown\Exceptions\InvalidDateFormatToCountdown;
use App\Core\Helpers\Countdown\Exceptions\InvalidPropertyStringForHumanException;
...
class Countdown
{
    ...
    {
        $this->days = $this->from->diffInDays($this->to);
     ...
     * @throws \App\Core\Helpers\Countdown\Exceptions\InvalidPropertyStringForHumanException
     * @return string
     */
