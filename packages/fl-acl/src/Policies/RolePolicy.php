...
class RolePolicy
{
     ...
     */
    public function view(User $user, IRole $role): bool
    {
        if ($this->isAppId()){
            return true;
        } 
     ...
     */
    public function update(User $user, IRole $role): bool
    {
        if ($this->isAppId()){
            return true;
        } 
     ...
     */
    public function delete(User $user, IRole $role): bool
    {
        if ($this->isAppId()){
            return true;
        } 
     ...
     */
    public function restore(User $user, IRole $role): bool
    {
        if ($this->isAppId()){
            return true;
        } 
     ...
     */
    public function forceDelete(User $user, IRole $role): bool
    {
        if ($this->isAppId()){
            return true;
        } 
